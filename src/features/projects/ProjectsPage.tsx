...
import { getAllTech, getProjects } from "../../content/projects";
import type { ProjectTech } from "../../entities/project/types";
...
export function ProjectsPage() {
   ...
   const techOptions = useMemo(() => getAllTech(lang) as ProjectTech[], [lang]);
